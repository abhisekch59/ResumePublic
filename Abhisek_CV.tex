...
% Define a variable
\newcommand{\email}{REDACTED@REDACTED.com}
\newcommand{\phone}{REDACTED}
...
\begin{center}
    \hspace{-\hoffset}
    \href{mailto:\email}{\email}  ~\textbullet~ Packaged App Development Specialist, Accenture ~\textbullet~ \(+91\) \phone
\end{center}
\vspace{-7mm}
\begin{resume}
...
\textbf{Packaged App Development Specialist, \href{https://www.linkedin.com/company/accentureindia/}{Accenture}} \hfill{July, 2023 - Current}\\
$\Rightarrow$ Working on a \textbf{S4 RISE Greenfield implementation} for an Indian pharmaceutical giant\\
$\Rightarrow$ Developed \textbf{RAP} applications with multi page navigations and validations\\
$\Rightarrow$ Followed \textbf{Clean Core} development guidelines\\
$\Rightarrow$ Generated \textbf{Fiori Elements} application from \textbf{RAP OData} service, added \textbf{extensions}\\
$\Rightarrow$ Used \textbf{AI} tools such as \textbf{Joule for Developers} and \textbf{Copilot} to increase productivity\\
$\Rightarrow$ Worked on a \textbf{S4 On-Premise Greenfield implementation} for an Indian automobile giant\\
$\Rightarrow$ Worked on \textbf{Payroll}, \textbf{MM}, \textbf{QM}, \textbf{FI} and \textbf{PP} modules as \textbf{Full-Stack} developer\\
$\Rightarrow$ Worked on \textbf{Flexible Workflows}, \textbf{Screen Personas}, \textbf{DMS Attachments} and various \textbf{RICEF}s\\
$\Rightarrow$ Developed custom \textbf{UI5} applications (both \textbf{On-Prem} and \textbf{BTP})\\
...
$\Rightarrow$ Worked additionally on \textbf{OpenUI5}\\
\\
\textbf{Technologies worked on:} \begin{tabular}{ l l }
	\textbullet~Classic ABAP / HR ABAP / RAP & \textbullet~OO-ABAP / ABAP on Cloud\\
	\textbullet~Adobe Forms & \textbullet~OData / SPROXY\\
	\textbullet~SAPUI5/OpenUI5 & \textbullet~Exits/Enhancements/BADIs\\
	\textbullet~AMDP & \textbullet~CDS Views\\
	\textbullet~Flexible Workflows & \textbullet~Module Pool\\
	\textbullet~SAP Build Work Zone & \textbullet~SAP Screen Personas\\
	%\textbullet~CDS Views & \\
	%\textbullet~REST APIs & \\
\end{tabular}\\
\\
\textbf{Tools used:} \begin{tabular}{ l l l }
	\textbullet~SAP GUI & \textbullet~Eclipse ADT & \textbullet~Adobe LiveCycle Designer\\
	\textbullet~Business Application Studio & \textbullet~SAP WebIDE & \textbullet~Joule / Copilot\\
\end{tabular}\\
\\
\\
...
\textbf{Core Area} - SAP ABAP Development, RAP Development, FIORI, OData\\
...
\begin{itemize}[leftmargin=*]
	...
	\item SAP Certified Associate - Back-End Developer - ABAP Cloud (\href{https://www.credly.com/badges/34b26901-f992-4192-9ba6-2a1444306de0/public_url}{Certificate})
	\item SAP Certified - SAP Generative AI Developer (\href{https://www.credly.com/badges/7993cc61-c2d1-481a-88d8-69897684e130/public_url}{Certificate})
